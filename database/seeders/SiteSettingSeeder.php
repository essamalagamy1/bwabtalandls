...
class SiteSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $site = SiteSetting::create([
            'name' => [
                'ar' => 'بوابة مدارس الأندلس الأهلية',
                'en' => 'Al-Andalus Private & International Schools',
            ],
            'theme' => 'template1',
            'description' => [
                'ar' => 'بوابة مدارس الأندلس الأهلية بالمملكة العربية السعودية - صرح تعليمي رائد تأسس عام 1404هـ (1984م)، يهدف لبناء جيل رائد يمتلك قدرات تعلم عالمية عبر مجمعات تعليمية متميزة في جدة ومكة المكرمة والطائف وأبها وخميس مشيط والجوف ونجران.',
            ...
            'about_us' => [
                'ar' => '<div class="about-us-content">
                    <h2>عن بوابة مدارس الأندلس الأهلية</h2>
            ...
            'privacy_policy' => [
                'ar' => '<div class="privacy-policy-content">
                    ...
                    <h3>مقدمة</h3>
                    <p>تلتزم إدارة بوابة مدارس الأندلس الأهلية بحماية خصوصية الطلاب وأولياء الأمور والمستخدمين لمنصتنا الإلكترونية، وفقاً للأنظمة واللوائح المعمول بها في المملكة العربية السعودية وضوابط الهيئة الوطنية للأمن السيبراني.</p>
            ...
            'terms_and_conditions' => [
                'ar' => '<div class="terms-conditions-content">
                    ...
                    <h3>مقدمة</h3>
                    <p>مرحباً بكم في المنصة الإلكترونية لبوابة مدارس الأندلس الأهلية. استخدامكم لهذه المنصة يُعد موافقة كاملة على الالتزام بالشروط والأحكام المبينة أدناه.</p>
